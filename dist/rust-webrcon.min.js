...
d.prototype.send=function(a,b,c,e){if(!this.b)return e("Connection isn't established yet");a=JSON.stringify({Identifier:b,Message:a,Name:"WebRcon"});this.a.onerror=function(){return e("Error in connection establishment")};this.a.onmessage=function(a){return c(JSON.parse(a.data))};this.a.send(a)};window.RustWebRcon=d;})(window);
