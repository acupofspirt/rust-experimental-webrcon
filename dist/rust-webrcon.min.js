...
d.prototype.close=function(){var a=this;return new Promise(function(b){if(a.b&&1===a.a.readyState)a.a.close(1E3),a.a.onclose=function(){a.b=!1;return b(1)};else throw Error("Connection isn't established yet");})};d.prototype.cmd=function(a,b){b=void 0===b?-1:b;var c=this;return new Promise(function(e,f){c.send(a,b,e,f)})};d.prototype.cmdThen=function(a,b){b=void 0===b?-1:b;var c=this;return function(){return new Promise(function(e,f){c.send(a,b,e,f)})}};
